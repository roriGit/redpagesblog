...
if( ! function_exists( 'blog_element_primary_navigation_fallback' ) ) :
	 ...
	 * @since 1.0.0
	 */
	function blog_element_primary_navigation_fallback() {
		
		echo '<ul>';
			echo '<li><a href="' . esc_url( home_url( '/' ) ) . '">' .esc_html__( 'Home', 'blog-element' ). '</a></li>';
			wp_list_pages( array(
			'title_li' => '',
			'depth'    => 1,
			'number'   => 5,
...
/**
 * Class blog_element_Dropdown_Taxonomies_Control
 */
class blog_element_Dropdown_Taxonomies_Control extends WP_Customize_Control {
    ...
    public function render_content() {
        $dropdown = wp_dropdown_categories(
            array(
                'name'              => 'blog-element-dropdown-categories-' . $this->id,
                'echo'              => 0,
                'show_option_none'  => __( '&mdash; Select &mdash;', 'blog-element' ),
                'option_none_value' => '0',
                'selected'          => $this->value(),
                'hide_empty'        => 0,                   
 ...
 */
class blog_element_Repeater_Text_Control extends WP_Customize_Control {
    ...
    public function render_content() {
        ...
        <label class="repeater-text-input">
            ...
            <a href="#" class="button button-primary btn-add-field"><?php esc_html_e( 'Add New', 'blog-element' ) ?></a>
 ...
 * @access public
 */
class blog_element_Customize_Section_Upsell extends WP_Customize_Section {
     ...
     * @var    string
     */
    public $type = 'blog-element-upsell';
